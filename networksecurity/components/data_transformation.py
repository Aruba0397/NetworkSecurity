...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        logging.info("Entered the get_data_transformer_object class for KNN imputation")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info("intialize KNN imputer")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered initaied data transfromation method")
        try:
            ...
            #training dataframe for independent and dependebt features
            ...
            #model pusher ro final models folder for deployment
